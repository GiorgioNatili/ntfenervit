...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ITSRelConsultant'
        db.create_table(u'campaigns_itsrelconsultant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consultant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'])),
            ('its', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'campaigns', ['ITSRelConsultant'])

        # Adding model 'ITSRelDistrict'
        db.create_table(u'campaigns_itsreldistrict', (
            ('its', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['campaigns.District'])),
        ))
        db.send_create_signal(u'campaigns', ['ITSRelDistrict'])

        # Adding model 'District'
        db.create_table(u'campaigns_district', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('district_manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ))
        db.send_create_signal(u'campaigns', ['District'])


    def backwards(self, orm):
        # Deleting model 'ITSRelConsultant'
        db.delete_table(u'campaigns_itsrelconsultant')

        # Deleting model 'ITSRelDistrict'
        db.delete_table(u'campaigns_itsreldistrict')

        # Deleting model 'District'
        db.delete_table(u'campaigns_district')
    ...
    models = {
        ...
        u'campaigns.district': {
            'Meta': {'object_name': 'District'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'district_manager': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'campaigns.event': {
            ...
            'consultant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contacts.Contact']", 'null': 'True', 'blank': 'True'}),
            ...
            'its_districtmanager': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'my_its_events'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'my_owned_events'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'visible_for_its': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        ...
        u'campaigns.itsrelconsultant': {
            'Meta': {'object_name': 'ITSRelConsultant'},
            'consultant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contacts.Contact']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'its': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'campaigns.itsreldistrict': {
            'Meta': {'object_name': 'ITSRelDistrict'},
            'district': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['campaigns.District']"}),
            'its': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'primary_key': 'True'})
        },
        ...
        u'campaigns.productgroup': {
            'Meta': {'object_name': 'ProductGroup'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sell_in_alloc': ('django.db.models.fields.FloatField', [], {}),
            'sell_in_amount': ('django.db.models.fields.FloatField', [], {})
        },
        u'campaigns.survey': {
