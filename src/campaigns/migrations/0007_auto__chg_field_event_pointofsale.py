...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.pointofsale'
        db.alter_column(u'campaigns_event', 'pointofsale', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Event.pointofsale'
        db.alter_column(u'campaigns_event', 'pointofsale', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
    ...
    models = {
        ...
        u'campaigns.event': {
            ...
            'pointofsale': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
