...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.its_districtmanager'
        db.add_column(u'campaigns_event', 'its_districtmanager',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='my_events', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.owner'
        db.add_column(u'campaigns_event', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='my_owned_events', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.visible_for_its'
        db.add_column(u'campaigns_event', 'visible_for_its',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Event.consultant'
        db.add_column(u'campaigns_event', 'consultant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.its_districtmanager'
        db.delete_column(u'campaigns_event', 'its_districtmanager_id')

        # Deleting field 'Event.owner'
        db.delete_column(u'campaigns_event', 'owner_id')

        # Deleting field 'Event.visible_for_its'
        db.delete_column(u'campaigns_event', 'visible_for_its')

        # Deleting field 'Event.consultant'
        db.delete_column(u'campaigns_event', 'consultant_id')
    ...
    models = {
        ...
        u'campaigns.event': {
            ...
            'its_districtmanager': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'my_events'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
