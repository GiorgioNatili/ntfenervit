...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'campaigns_productgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('sell_in_alloc', self.gf('django.db.models.fields.FloatField')()),
            ('sell_in_amount', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'campaigns', ['ProductGroup'])


    def backwards(self, orm):
        # Deleting model 'ProductGroup'
        db.delete_table(u'campaigns_productgroup')
