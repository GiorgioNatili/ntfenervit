...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventSignup.coupon'
        db.add_column(u'campaigns_eventsignup', 'coupon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coupon.Coupon'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventSignup.coupon'
        db.delete_column(u'campaigns_eventsignup', 'coupon_id')
