...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RankingConfiguration'
        db.create_table(u'contacts_rankingconfiguration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('minvalue', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('maxvalue', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10)),
            ('eventsignup', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('eventpresence', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('survey', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('inactive', self.gf('django.db.models.fields.SmallIntegerField')(default=-1)),
            ('active_threshold', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('inactivity_period', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=24)),
        ))
        db.send_create_signal(u'contacts', ['RankingConfiguration'])


    def backwards(self, orm):
        # Deleting model 'RankingConfiguration'
        db.delete_table(u'contacts_rankingconfiguration')
